  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            rusty-nix = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        rusty-nix-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        rusty-nix-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        rusty-nix-audit = craneLib.cargoAudit {
      ...
      packages = forAllSystems ({ rusty-nix, ... }: {
        inherit rusty-nix;
        default = rusty-nix;
      });
      ...
      apps = forAllSystems ({system, ...}: {
        rusty-nix = {
          type = "app";
          program = "${self.packages.${system}.rusty-nix}/bin/rusty-nix";
        };
        default = self.apps.${system}.rusty-nix;
      });
